...
TEST(Li24, sign_t_n_mt) {
    string file_name_1 = IS_NN?"secp256k1_Li24_nn.txt":"secp256k1_Li24.txt";
    string file_name_2 = IS_NN?"p256_Li24_nn.txt":"p256_Li24.txt";
