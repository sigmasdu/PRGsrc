...
#ifndef SAFEHERON_MULTI_PARTY_ECDSA_Li24_SIGN_ONCE_ROUND2_H
#define SAFEHERON_MULTI_PARTY_ECDSA_Li24_SIGN_ONCE_ROUND2_H
...
private:
    bool MakeP2PMessage(size_t start,size_t end,std::vector<std::string> &out_p2p_msg_arr)const;
};
...
#endif //SAFEHERON_MULTI_PARTY_ECDSA_Li24_SIGN_ONCE_ROUND2_H
