...
#ifndef SAFEHERON_MULTI_PARTY_ECDSA_Li24_SIGN_UTIL_H
#define SAFEHERON_MULTI_PARTY_ECDSA_Li24_SIGN_UTIL_H
...
#endif //SAFEHERON_MULTI_PARTY_ECDSA_Li24_SIGN_UTIL_H
