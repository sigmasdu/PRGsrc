...
import (
	...
	//"github.com/taurusgroup/multi-party-sig/protocols/Li24/presign"
	"github.com/taurusgroup/multi-party-sig/protocols/Li24/sign"
)
...
func Refresh(config *Config, pl *pool.Pool) protocol.StartFunc {
	info := round.Info{
		ProtocolID:       "Li24/refresh-threshold",
		FinalRoundNumber: keygen.Rounds,
		SelfID:           config.ID,
